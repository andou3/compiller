/* The following code was generated by JFlex 1.4.3 on 09.11.17 2:46 */
 ...
 * on 09.11.17 2:46 from the specification file
 * <tt>lab2.jflex</tt>
 */
class Lab2 {
...
enum Lexer {
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java Lab2 <inputfile>");
    }
    else {
      for (int i = 0; i < argv.length; i++) {
        Lab2 scanner = null;
        try {
          scanner = new Lab2( new java.io.FileReader(argv[i]) );
